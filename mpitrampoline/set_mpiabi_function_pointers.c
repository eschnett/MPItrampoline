...
MPIABI_Add_error_class_ptr = get_symbol(handle, "MPIABI_Add_error_class");
MPIABI_Add_error_code_ptr = get_symbol(handle, "MPIABI_Add_error_code");
MPIABI_Add_error_string_ptr = get_symbol(handle, "MPIABI_Add_error_string");
MPIABI_Alloc_mem_ptr = get_symbol(handle, "MPIABI_Alloc_mem");
MPIABI_Comm_call_errhandler_ptr =
    get_symbol(handle, "MPIABI_Comm_call_errhandler");
MPIABI_Comm_create_errhandler_ptr =
    get_symbol(handle, "MPIABI_Comm_create_errhandler");
MPIABI_Comm_get_errhandler_ptr =
    get_symbol(handle, "MPIABI_Comm_get_errhandler");
MPIABI_Comm_set_errhandler_ptr =
    get_symbol(handle, "MPIABI_Comm_set_errhandler");
MPIABI_Errhandler_free_ptr = get_symbol(handle, "MPIABI_Errhandler_free");
MPIABI_Error_class_ptr = get_symbol(handle, "MPIABI_Error_class");
MPIABI_Error_string_ptr = get_symbol(handle, "MPIABI_Error_string");
MPIABI_File_call_errhandler_ptr =
    get_symbol(handle, "MPIABI_File_call_errhandler");
MPIABI_File_create_errhandler_ptr =
    get_symbol(handle, "MPIABI_File_create_errhandler");
MPIABI_File_get_errhandler_ptr =
    get_symbol(handle, "MPIABI_File_get_errhandler");
MPIABI_File_set_errhandler_ptr =
    get_symbol(handle, "MPIABI_File_set_errhandler");
MPIABI_Free_mem_ptr = get_symbol(handle, "MPIABI_Free_mem");
MPIABI_Get_hw_resource_info_ptr =
    get_symbol(handle, "MPIABI_Get_hw_resource_info");
MPIABI_Get_library_version_ptr =
    get_symbol(handle, "MPIABI_Get_library_version");
MPIABI_Get_processor_name_ptr = get_symbol(handle, "MPIABI_Get_processor_name");
MPIABI_Get_version_ptr = get_symbol(handle, "MPIABI_Get_version");
MPIABI_Remove_error_class_ptr = get_symbol(handle, "MPIABI_Remove_error_class");
MPIABI_Remove_error_code_ptr = get_symbol(handle, "MPIABI_Remove_error_code");
MPIABI_Remove_error_string_ptr =
    get_symbol(handle, "MPIABI_Remove_error_string");
MPIABI_Session_call_errhandler_ptr =
    get_symbol(handle, "MPIABI_Session_call_errhandler");
MPIABI_Session_create_errhandler_ptr =
    get_symbol(handle, "MPIABI_Session_create_errhandler");
MPIABI_Session_get_errhandler_ptr =
    get_symbol(handle, "MPIABI_Session_get_errhandler");
MPIABI_Session_set_errhandler_ptr =
    get_symbol(handle, "MPIABI_Session_set_errhandler");
MPIABI_Win_call_errhandler_ptr =
    get_symbol(handle, "MPIABI_Win_call_errhandler");
MPIABI_Win_create_errhandler_ptr =
    get_symbol(handle, "MPIABI_Win_create_errhandler");
MPIABI_Win_get_errhandler_ptr = get_symbol(handle, "MPIABI_Win_get_errhandler");
MPIABI_Win_set_errhandler_ptr = get_symbol(handle, "MPIABI_Win_set_errhandler");
MPIABI_Wtick_ptr = get_symbol(handle, "MPIABI_Wtick");
MPIABI_Wtime_ptr = get_symbol(handle, "MPIABI_Wtime");

// A.3.8 The Info Object C Bindings

MPIABI_Info_create_ptr = get_symbol(handle, "MPIABI_Info_create");
MPIABI_Info_create_env_ptr = get_symbol(handle, "MPIABI_Info_create_env");
MPIABI_Info_delete_ptr = get_symbol(handle, "MPIABI_Info_delete");
MPIABI_Info_dup_ptr = get_symbol(handle, "MPIABI_Info_dup");
MPIABI_Info_free_ptr = get_symbol(handle, "MPIABI_Info_free");
MPIABI_Info_get_nkeys_ptr = get_symbol(handle, "MPIABI_Info_get_nkeys");
MPIABI_Info_get_nthkey_ptr = get_symbol(handle, "MPIABI_Info_get_nthkey");
MPIABI_Info_get_string_ptr = get_symbol(handle, "MPIABI_Info_get_string");
MPIABI_Info_set_ptr = get_symbol(handle, "MPIABI_Info_set");
...
MPIABI_Comm_c2f_ptr = get_symbol(handle, "MPIABI_Comm_c2f");
MPIABI_Comm_f2c_ptr = get_symbol(handle, "MPIABI_Comm_f2c");
MPIABI_Errhandler_c2f_ptr = get_symbol(handle, "MPIABI_Errhandler_c2f");
MPIABI_Errhandler_f2c_ptr = get_symbol(handle, "MPIABI_Errhandler_f2c");
MPIABI_File_c2f_ptr = get_symbol(handle, "MPIABI_File_c2f");
MPIABI_File_f2c_ptr = get_symbol(handle, "MPIABI_File_f2c");
MPIABI_Group_c2f_ptr = get_symbol(handle, "MPIABI_Group_c2f");
MPIABI_Group_f2c_ptr = get_symbol(handle, "MPIABI_Group_f2c");
MPIABI_Info_c2f_ptr = get_symbol(handle, "MPIABI_Info_c2f");
MPIABI_Info_f2c_ptr = get_symbol(handle, "MPIABI_Info_f2c");
MPIABI_Message_c2f_ptr = get_symbol(handle, "MPIABI_Message_c2f");
MPIABI_Message_f2c_ptr = get_symbol(handle, "MPIABI_Message_f2c");
MPIABI_Op_c2f_ptr = get_symbol(handle, "MPIABI_Op_c2f");
MPIABI_Op_f2c_ptr = get_symbol(handle, "MPIABI_Op_f2c");
MPIABI_Request_c2f_ptr = get_symbol(handle, "MPIABI_Request_c2f");
MPIABI_Request_f2c_ptr = get_symbol(handle, "MPIABI_Request_f2c");
MPIABI_Session_c2f_ptr = get_symbol(handle, "MPIABI_Session_c2f");
MPIABI_Session_f2c_ptr = get_symbol(handle, "MPIABI_Session_f2c");
MPIABI_Status_f082f_ptr = get_symbol(handle, "MPIABI_Status_f082f");
MPIABI_Status_c2f_ptr = get_symbol(handle, "MPIABI_Status_c2f");
MPIABI_Status_c2f08_ptr = get_symbol(handle, "MPIABI_Status_c2f08");
MPIABI_Status_f082c_ptr = get_symbol(handle, "MPIABI_Status_f082c");
MPIABI_Status_f2c_ptr = get_symbol(handle, "MPIABI_Status_f2c");
MPIABI_Status_f2f08_ptr = get_symbol(handle, "MPIABI_Status_f2f08");
MPIABI_Type_c2f_ptr = get_symbol(handle, "MPIABI_Type_c2f");
MPIABI_Type_create_f90_complex_ptr =
    get_symbol(handle, "MPIABI_Type_create_f90_complex");
MPIABI_Type_create_f90_integer_ptr =
    get_symbol(handle, "MPIABI_Type_create_f90_integer");
MPIABI_Type_create_f90_real_ptr =
    get_symbol(handle, "MPIABI_Type_create_f90_real");
MPIABI_Type_f2c_ptr = get_symbol(handle, "MPIABI_Type_f2c");
MPIABI_Type_match_size_ptr = get_symbol(handle, "MPIABI_Type_match_size");
MPIABI_Win_c2f_ptr = get_symbol(handle, "MPIABI_Win_c2f");
MPIABI_Win_f2c_ptr = get_symbol(handle, "MPIABI_Win_f2c");
...
MPIABI_T_category_changed_ptr = get_symbol(handle, "MPIABI_T_category_changed");
MPIABI_T_category_get_categories_ptr =
    get_symbol(handle, "MPIABI_T_category_get_categories");
MPIABI_T_category_get_cvars_ptr =
    get_symbol(handle, "MPIABI_T_category_get_cvars");
MPIABI_T_category_get_events_ptr =
    get_symbol(handle, "MPIABI_T_category_get_events");
MPIABI_T_category_get_index_ptr =
    get_symbol(handle, "MPIABI_T_category_get_index");
MPIABI_T_category_get_info_ptr =
    get_symbol(handle, "MPIABI_T_category_get_info");
MPIABI_T_category_get_num_ptr = get_symbol(handle, "MPIABI_T_category_get_num");
MPIABI_T_category_get_num_events_ptr =
    get_symbol(handle, "MPIABI_T_category_get_num_events");
MPIABI_T_category_get_pvars_ptr =
    get_symbol(handle, "MPIABI_T_category_get_pvars");
MPIABI_T_cvar_get_index_ptr = get_symbol(handle, "MPIABI_T_cvar_get_index");
MPIABI_T_cvar_get_info_ptr = get_symbol(handle, "MPIABI_T_cvar_get_info");
MPIABI_T_cvar_get_num_ptr = get_symbol(handle, "MPIABI_T_cvar_get_num");
MPIABI_T_cvar_handle_alloc_ptr =
    get_symbol(handle, "MPIABI_T_cvar_handle_alloc");
MPIABI_T_cvar_handle_free_ptr = get_symbol(handle, "MPIABI_T_cvar_handle_free");
MPIABI_T_cvar_read_ptr = get_symbol(handle, "MPIABI_T_cvar_read");
MPIABI_T_cvar_write_ptr = get_symbol(handle, "MPIABI_T_cvar_write");
MPIABI_T_enum_get_info_ptr = get_symbol(handle, "MPIABI_T_enum_get_info");
MPIABI_T_enum_get_item_ptr = get_symbol(handle, "MPIABI_T_enum_get_item");
MPIABI_T_event_callback_get_info_ptr =
    get_symbol(handle, "MPIABI_T_event_callback_get_info");
MPIABI_T_event_callback_set_info_ptr =
    get_symbol(handle, "MPIABI_T_event_callback_set_info");
MPIABI_T_event_copy_ptr = get_symbol(handle, "MPIABI_T_event_copy");
MPIABI_T_event_get_index_ptr = get_symbol(handle, "MPIABI_T_event_get_index");
MPIABI_T_event_get_info_ptr = get_symbol(handle, "MPIABI_T_event_get_info");
MPIABI_T_event_get_num_ptr = get_symbol(handle, "MPIABI_T_event_get_num");
MPIABI_T_event_get_source_ptr = get_symbol(handle, "MPIABI_T_event_get_source");
MPIABI_T_event_get_timestamp_ptr =
    get_symbol(handle, "MPIABI_T_event_get_timestamp");
MPIABI_T_event_handle_alloc_ptr =
    get_symbol(handle, "MPIABI_T_event_handle_alloc");
MPIABI_T_event_handle_free_ptr =
    get_symbol(handle, "MPIABI_T_event_handle_free");
MPIABI_T_event_handle_get_info_ptr =
    get_symbol(handle, "MPIABI_T_event_handle_get_info");
MPIABI_T_event_handle_set_info_ptr =
    get_symbol(handle, "MPIABI_T_event_handle_set_info");
MPIABI_T_event_read_ptr = get_symbol(handle, "MPIABI_T_event_read");
MPIABI_T_event_register_callback_ptr =
    get_symbol(handle, "MPIABI_T_event_register_callback");
MPIABI_T_event_set_dropped_handler_ptr =
    get_symbol(handle, "MPIABI_T_event_set_dropped_handler");
MPIABI_T_finalize_ptr = get_symbol(handle, "MPIABI_T_finalize");
MPIABI_T_init_thread_ptr = get_symbol(handle, "MPIABI_T_init_thread");
MPIABI_T_pvar_get_index_ptr = get_symbol(handle, "MPIABI_T_pvar_get_index");
MPIABI_T_pvar_get_info_ptr = get_symbol(handle, "MPIABI_T_pvar_get_info");
MPIABI_T_pvar_get_num_ptr = get_symbol(handle, "MPIABI_T_pvar_get_num");
MPIABI_T_pvar_handle_alloc_ptr =
    get_symbol(handle, "MPIABI_T_pvar_handle_alloc");
MPIABI_T_pvar_handle_free_ptr = get_symbol(handle, "MPIABI_T_pvar_handle_free");
MPIABI_T_pvar_read_ptr = get_symbol(handle, "MPIABI_T_pvar_read");
MPIABI_T_pvar_readreset_ptr = get_symbol(handle, "MPIABI_T_pvar_readreset");
MPIABI_T_pvar_reset_ptr = get_symbol(handle, "MPIABI_T_pvar_reset");
MPIABI_T_pvar_session_create_ptr =
    get_symbol(handle, "MPIABI_T_pvar_session_create");
MPIABI_T_pvar_session_free_ptr =
    get_symbol(handle, "MPIABI_T_pvar_session_free");
MPIABI_T_pvar_start_ptr = get_symbol(handle, "MPIABI_T_pvar_start");
MPIABI_T_pvar_stop_ptr = get_symbol(handle, "MPIABI_T_pvar_stop");
MPIABI_T_pvar_write_ptr = get_symbol(handle, "MPIABI_T_pvar_write");
MPIABI_T_source_get_info_ptr = get_symbol(handle, "MPIABI_T_source_get_info");
MPIABI_T_source_get_num_ptr = get_symbol(handle, "MPIABI_T_source_get_num");
MPIABI_T_source_get_timestamp_ptr =
    get_symbol(handle, "MPIABI_T_source_get_timestamp");
