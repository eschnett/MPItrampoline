...
!gcc$    attributes no_arg_check :: buf
     ...
     &)
         ...
         logical, intent(out) :: flag
         integer, intent(out) ::                                        &
     &      array_of_statuses(MPI_STATUS_SIZE, count)
         integer, intent(out) :: ierror
     ...
     &)
         ...
         integer, intent(out) ::                                        &
     &      array_of_statuses(MPI_STATUS_SIZE, incount)
         integer, intent(out) :: ierror
...
!gcc$    attributes no_arg_check :: outbuf
     ...
     &)
         ...
         integer(MPI_ADDRESS_KIND), intent(in) ::                       &
...
!gcc$    attributes no_arg_check :: location
     ...
     &)
         ...
         integer(MPI_ADDRESS_KIND), intent(out) ::                      &
     &      array_of_displacements
         integer, intent(in) :: oldtype
         integer, intent(out) :: newtype
         integer, intent(out) :: ierror
