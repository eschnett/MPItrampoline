...
int (*MPIABI_Bsend)(const void *buf, int count, MPIABI_Datatype datatype,
...
int (*MPIABI_Irsend_c)(const void *buf, MPIABI_Count count,
                       MPIABI_Datatype datatype, int dest, int tag,
                       MPIABI_Comm comm, MPIABI_Request *request);
int (*MPIABI_Isend)(const void *buf, int count, MPIABI_Datatype datatype,
                    int dest, int tag, MPIABI_Comm comm,
                    MPIABI_Request *request);
...
int (*MPIABI_Recv_c)(void *buf, MPIABI_Count count, MPIABI_Datatype datatype,
                     int source, int tag, MPIABI_Comm comm,
                     MPIABI_Status *status);
int (*MPIABI_Recv_init)(void *buf, int count, MPIABI_Datatype datatype,
                        int source, int tag, MPIABI_Comm comm,
                        MPIABI_Request *request);
int (*MPIABI_Recv_init_c)(void *buf, MPIABI_Count count,
...
int (*MPIABI_Request_get_status_some)(int incount,
                                      ...
                                      MPIABI_Status array_of_statuses[]);
int (*MPIABI_Rsend)(const void *buf, int count, MPIABI_Datatype datatype,
                    int dest, int tag, MPIABI_Comm comm);
...
int (*MPIABI_Rsend_init_c)(const void *buf, MPIABI_Count count,
                           MPIABI_Datatype datatype, int dest, int tag,
                           MPIABI_Comm comm, MPIABI_Request *request);
int (*MPIABI_Send)(const void *buf, int count, MPIABI_Datatype datatype,
                   int dest, int tag, MPIABI_Comm comm);
int (*MPIABI_Send_c)(const void *buf, MPIABI_Count count,
                     MPIABI_Datatype datatype, int dest, int tag,
                     MPIABI_Comm comm);
...
int (*MPIABI_Session_iflush_buffer)(MPIABI_Session session,
                                    MPIABI_Request *request);
int (*MPIABI_Ssend)(const void *buf, int count, MPIABI_Datatype datatype,
                    int dest, int tag, MPIABI_Comm comm);
...
int (*MPIABI_Get_elements)(const MPIABI_Status *status,
                           MPIABI_Datatype datatype, int *count);
int (*MPIABI_Get_elements_c)(const MPIABI_Status *status,
...
int (*MPIABI_Pack_c)(const void *inbuf, MPIABI_Count incount,
                     ...
                     MPIABI_Comm comm);
int (*MPIABI_Pack_external)(const char datarep[], const void *inbuf,
                            int incount, MPIABI_Datatype datatype, void *outbuf,
...
int (*MPIABI_Type_create_hindexed_block_c)(
    ...
    MPIABI_Datatype *newtype);
int (*MPIABI_Type_create_hindexed_c)(
    MPIABI_Count count, const MPIABI_Count array_of_blocklengths[],
    const MPIABI_Count array_of_displacements[], MPIABI_Datatype oldtype,
    MPIABI_Datatype *newtype);
int (*MPIABI_Type_create_hvector)(int count, int blocklength,
                                  MPIABI_Aint stride, MPIABI_Datatype oldtype,
                                  MPIABI_Datatype *newtype);
int (*MPIABI_Type_create_hvector_c)(MPIABI_Count count,
...
int (*MPIABI_Allreduce)(const void *sendbuf, void *recvbuf, int count,
                        ...
                        MPIABI_Comm comm);
int (*MPIABI_Allreduce_c)(const void *sendbuf, void *recvbuf,
...
int (*MPIABI_Bcast)(void *buffer, int count, MPIABI_Datatype datatype, int root,
                    MPIABI_Comm comm);
int (*MPIABI_Bcast_c)(void *buffer, MPIABI_Count count,
...
int (*MPIABI_Exscan_init)(const void *sendbuf, void *recvbuf, int count,
                          ...
                          MPIABI_Comm comm, MPIABI_Info info,
                          MPIABI_Request *request);
int (*MPIABI_Exscan_init_c)(const void *sendbuf, void *recvbuf,
                            MPIABI_Count count, MPIABI_Datatype datatype,
                            MPIABI_Op op, MPIABI_Comm comm, MPIABI_Info info,
                            MPIABI_Request *request);
int (*MPIABI_Gather)(const void *sendbuf, int sendcount,
                     MPIABI_Datatype sendtype, void *recvbuf, int recvcount,
...
int (*MPIABI_Gather_init_c)(const void *sendbuf, MPIABI_Count sendcount,
                            ...
                            int root, MPIABI_Comm comm, MPIABI_Info info,
                            MPIABI_Request *request);
int (*MPIABI_Gatherv)(const void *sendbuf, int sendcount,
                      MPIABI_Datatype sendtype, void *recvbuf,
                      const int recvcounts[], const int displs[],
                      MPIABI_Datatype recvtype, int root, MPIABI_Comm comm);
...
int (*MPIABI_Iallreduce)(const void *sendbuf, void *recvbuf, int count,
                         MPIABI_Datatype datatype, MPIABI_Op op,
                         MPIABI_Comm comm, MPIABI_Request *request);
int (*MPIABI_Iallreduce_c)(const void *sendbuf, void *recvbuf,
                           MPIABI_Count count, MPIABI_Datatype datatype,
                           MPIABI_Op op, MPIABI_Comm comm,
                           MPIABI_Request *request);
...
int (*MPIABI_Ibcast)(void *buffer, int count, MPIABI_Datatype datatype,
                     int root, MPIABI_Comm comm, MPIABI_Request *request);
int (*MPIABI_Ibcast_c)(void *buffer, MPIABI_Count count,
                       MPIABI_Datatype datatype, int root, MPIABI_Comm comm,
                       MPIABI_Request *request);
...
int (*MPIABI_Iexscan_c)(const void *sendbuf, void *recvbuf, MPIABI_Count count,
                        MPIABI_Datatype datatype, MPIABI_Op op,
                        MPIABI_Comm comm, MPIABI_Request *request);
int (*MPIABI_Igather)(const void *sendbuf, int sendcount,
                      MPIABI_Datatype sendtype, void *recvbuf, int recvcount,
                      MPIABI_Datatype recvtype, int root, MPIABI_Comm comm,
                      MPIABI_Request *request);
...
int (*MPIABI_Reduce_init)(const void *sendbuf, void *recvbuf, int count,
                          ...
                          MPIABI_Comm comm, MPIABI_Info info,
                          MPIABI_Request *request);
int (*MPIABI_Reduce_init_c)(const void *sendbuf, void *recvbuf,
                            MPIABI_Count count, MPIABI_Datatype datatype,
                            MPIABI_Op op, int root, MPIABI_Comm comm,
                            MPIABI_Info info, MPIABI_Request *request);
int (*MPIABI_Reduce_local)(const void *inbuf, void *inoutbuf, int count,
                           MPIABI_Datatype datatype, MPIABI_Op op);
int (*MPIABI_Reduce_local_c)(const void *inbuf, void *inoutbuf,
                             MPIABI_Count count, MPIABI_Datatype datatype,
                             MPIABI_Op op);
...
int (*MPIABI_Scan_init)(const void *sendbuf, void *recvbuf, int count,
                        ...
                        MPIABI_Comm comm, MPIABI_Info info,
                        MPIABI_Request *request);
int (*MPIABI_Scan_init_c)(const void *sendbuf, void *recvbuf,
                          MPIABI_Count count, MPIABI_Datatype datatype,
                          MPIABI_Op op, MPIABI_Comm comm, MPIABI_Info info,
                          MPIABI_Request *request);
int (*MPIABI_Scatter)(const void *sendbuf, int sendcount,
                      MPIABI_Datatype sendtype, void *recvbuf, int recvcount,
                      MPIABI_Datatype recvtype, int root, MPIABI_Comm comm);
...
int (*MPIABI_Scatterv_init)(const void *sendbuf, const int sendcounts[],
                            ...
                            MPIABI_Comm comm, MPIABI_Info info,
                            MPIABI_Request *request);
int (*MPIABI_Scatterv_init_c)(const void *sendbuf,
                              const MPIABI_Count sendcounts[],
                              const MPIABI_Aint displs[],
                              MPIABI_Datatype sendtype, void *recvbuf,
                              MPIABI_Count recvcount, MPIABI_Datatype recvtype,
...
int (*MPIABI_Comm_get_attr)(MPIABI_Comm comm, int comm_keyval,
...
int (*MPIABI_Group_translate_ranks)(MPIABI_Group group1, int n,
...
int (*MPIABI_Cart_coords)(MPIABI_Comm comm, int rank, int maxdims,
                          int coords[]);
...
int (*MPIABI_Dist_graph_create)(MPIABI_Comm comm_old, int n,
                                const int sources[], const int degrees[],
                                const int destinations[], const int weights[],
                                MPIABI_Info info, int reorder,
...
int (*MPIABI_Graph_get)(MPIABI_Comm comm, int maxindex, int maxedges,
                        int index[], int edges[]);
...
int (*MPIABI_Ineighbor_allgatherv)(const void *sendbuf, int sendcount,
                                   ...
                                   MPIABI_Datatype recvtype, MPIABI_Comm comm,
                                   MPIABI_Request *request);
int (*MPIABI_Ineighbor_allgatherv_c)(
...
int (*MPIABI_Neighbor_allgatherv_c)(const void *sendbuf, MPIABI_Count sendcount,
                                    ...
                                    const MPIABI_Aint displs[],
                                    MPIABI_Datatype recvtype, MPIABI_Comm comm);
int (*MPIABI_Neighbor_allgatherv_init)(
...
int (*MPIABI_Neighbor_alltoall_init)(const void *sendbuf, int sendcount,
                                     ...
                                     MPIABI_Comm comm, MPIABI_Info info,
                                     MPIABI_Request *request);
int (*MPIABI_Neighbor_alltoall_init_c)(
    const void *sendbuf, MPIABI_Count sendcount, MPIABI_Datatype sendtype,
    void *recvbuf, MPIABI_Count recvcount, MPIABI_Datatype recvtype,
    MPIABI_Comm comm, MPIABI_Info info, MPIABI_Request *request);
...
int (*MPIABI_Neighbor_alltoallv_c)(const void *sendbuf,
                                   ...
                                   const MPIABI_Aint rdispls[],
                                   MPIABI_Datatype recvtype, MPIABI_Comm comm);
int (*MPIABI_Neighbor_alltoallv_init)(
...
int (*MPIABI_Comm_get_errhandler)(MPIABI_Comm comm,
                                  MPIABI_Errhandler *errhandler);
int (*MPIABI_Comm_set_errhandler)(MPIABI_Comm comm,
                                  MPIABI_Errhandler errhandler);
...
int (*MPIABI_File_get_errhandler)(MPIABI_File file,
                                  MPIABI_Errhandler *errhandler);
int (*MPIABI_File_set_errhandler)(MPIABI_File file,
                                  MPIABI_Errhandler errhandler);
...
int (*MPIABI_Session_get_nth_pset)(MPIABI_Session session, MPIABI_Info info,
...
int (*MPIABI_Session_get_pset_info)(MPIABI_Session session,
                                    const char *pset_name, MPIABI_Info *info);
...
int (*MPIABI_Accumulate_c)(const void *origin_addr, MPIABI_Count origin_count,
                           ...
                           MPIABI_Datatype target_datatype, MPIABI_Op op,
                           MPIABI_Win win);
int (*MPIABI_Compare_and_swap)(const void *origin_addr,
...
int (*MPIABI_Rget_accumulate)(const void *origin_addr, int origin_count,
                              ...
                              MPIABI_Datatype target_datatype, MPIABI_Op op,
                              MPIABI_Win win, MPIABI_Request *request);
int (*MPIABI_Rget_accumulate_c)(const void *origin_addr,
                                MPIABI_Count origin_count,
                                MPIABI_Datatype origin_datatype,
                                void *result_addr, MPIABI_Count result_count,
...
int (*MPIABI_Status_set_elements)(MPIABI_Status *status,
                                  MPIABI_Datatype datatype, int count);
...
int (*MPIABI_File_iread_at_all)(MPIABI_File fh, MPIABI_Offset offset, void *buf,
                                int count, MPIABI_Datatype datatype,
                                MPIABI_Request *request);
int (*MPIABI_File_iread_at_all_c)(MPIABI_File fh, MPIABI_Offset offset,
...
int (*MPIABI_File_iwrite_all_c)(MPIABI_File fh, const void *buf,
                                MPIABI_Count count, MPIABI_Datatype datatype,
                                MPIABI_Request *request);
int (*MPIABI_File_iwrite_at)(MPIABI_File fh, MPIABI_Offset offset,
...
int (*MPIABI_File_read_all_begin)(MPIABI_File fh, void *buf, int count,
                                  MPIABI_Datatype datatype);
int (*MPIABI_File_read_all_begin_c)(MPIABI_File fh, void *buf,
                                    MPIABI_Count count,
                                    MPIABI_Datatype datatype);
...
int (*MPIABI_File_read_at_all_begin_c)(MPIABI_File fh, MPIABI_Offset offset,
                                       void *buf, MPIABI_Count count,
                                       MPIABI_Datatype datatype);
int (*MPIABI_File_read_at_all_c)(MPIABI_File fh, MPIABI_Offset offset,
                                 void *buf, MPIABI_Count count,
                                 MPIABI_Datatype datatype,
                                 MPIABI_Status *status);
...
int (*MPIABI_File_seek_shared)(MPIABI_File fh, MPIABI_Offset offset,
                               int whence);
...
int (*MPIABI_File_write_all_begin_c)(MPIABI_File fh, const void *buf,
                                     MPIABI_Count count,
                                     MPIABI_Datatype datatype);
int (*MPIABI_File_write_all_c)(MPIABI_File fh, const void *buf,
                               MPIABI_Count count, MPIABI_Datatype datatype,
                               MPIABI_Status *status);
int (*MPIABI_File_write_all_end)(MPIABI_File fh, const void *buf,
                                 MPIABI_Status *status);
int (*MPIABI_File_write_at)(MPIABI_File fh, MPIABI_Offset offset,
                            const void *buf, int count,
                            MPIABI_Datatype datatype, MPIABI_Status *status);
...
int (*MPIABI_File_write_ordered)(MPIABI_File fh, const void *buf, int count,
                                 MPIABI_Datatype datatype,
                                 MPIABI_Status *status);
int (*MPIABI_File_write_ordered_begin)(MPIABI_File fh, const void *buf,
                                       int count, MPIABI_Datatype datatype);
...
int (*MPIABI_T_event_copy)(MPIABI_T_event_instance event_instance,
                           void *buffer);
...
int (*MPIABI_T_pvar_get_index)(const char *name, int var_class,
                               int *pvar_index);
...
int (*MPIABI_T_pvar_handle_alloc)(MPIABI_T_pvar_session pe_session,
...
int (*MPIABI_Get_elements_x)(const MPIABI_Status *status,
                             MPIABI_Datatype datatype, MPIABI_Count *count);
int (*MPIABI_Info_get)(MPIABI_Info info, const char *key, int valuelen,
                       char *value, int *flag);
int (*MPIABI_Info_get_valuelen)(MPIABI_Info info, const char *key,
